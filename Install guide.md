...
| 구분 | 실행 위치 | 용도 |
|---|---|---|
| 프로그램 1 | Windows | X-Plane 12 실행 |
| 프로그램 2 | Windows | QGroundControl 실행 |
| 터미널 1 | WSL Ubuntu 터미널 1 | mavlink-routerd 실행 |
| 터미널 2 | WSL Ubuntu 터미널 2 | PX4 SITL 실행 |
| 터미널 3 | Windows PowerShell | WSL IP 확인, X-Plane 경로 확인 |
...
**[창 1 = Ubuntu 터미널 1 또는 일반 WSL Ubuntu]**
...
- 127.0.0.1:14569  → 보통 고정 사용 가능
  0.0.0.0:14550    → 보통 고정 사용 가능
  172.xx.xxx.1     → PC/환경마다 확인해서 변경 필요
- 이 터미널은 계속 켜둔다.
```
